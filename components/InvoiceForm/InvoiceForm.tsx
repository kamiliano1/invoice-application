  ...
  return (
    <Form {...form}>
      <form
        ...
        className="flex max-h-screen max-w-[616px] flex-col overflow-y-scroll rounded-tr-[20px] bg-white sm:min-h-[calc(100vh_-_80px)] sm:w-[616px] lg:ml-[103px] lg:h-full dark:bg-12"
      >
