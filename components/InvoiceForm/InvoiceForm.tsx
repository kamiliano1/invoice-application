      ...
      >
        <div className="px-4 sm:p-14 flex flex-col gap-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-col w-full">
                  <FormLabel className="text-bodyVariant mb-2 text-07 dark:text-05">
                    Invoice Date
                  </FormLabel>
                  <Popover>
          ...
          <div className="hidden list-none sm:grid gap-x-4 grid-cols-[minmax(0,_.5fr)_minmax(0,_.7fr)_minmax(0,_.7fr)_minmax(0,_.3fr)] sm:grid-cols-[minmax(0,_1.6fr)_minmax(0,_.4fr)_minmax(0,_.7fr)_minmax(0,_.7fr)_minmax(0,_.2fr)] items-center">
            ...
            <p className="text-bodyVariant mb-2 text-07 dark:text-05">Price</p>
            <p className="text-bodyVariant mb-2 text-07 dark:text-05">Total</p>
          </div>
