...
import { z } from "zod";
import PreviewInvoiceSkeleton, {
  PreviewInvoiceButtonsMobileSkeleton,
} from "./PreviewInvoiceSkeleton";
...
export default function PreviewInvoice({
  ...
  const [setskeletonik, setSetskeletonik] = useState(false);
  return (
    <div className="max-w-[778px] mx-auto w-full">
      <button onClick={() => setSetskeletonik((prev) => !prev)}>
        Zmien Skielotink
      </button>
      <BackButton
        className="pt-6 px-6"
